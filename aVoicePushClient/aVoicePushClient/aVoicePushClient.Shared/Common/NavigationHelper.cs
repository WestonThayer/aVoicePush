...
namespace aVoicePushClient.Common
{
    /// <summary>
    ...
    public class NavigationHelper : DependencyObject
    {
        ...
        {
            if (BackPressed != null && !BackPressed(sender, e))
            {
                e.Handled = true;
            }
            else if (this.GoBackCommand.CanExecute(null))
            {
                this.GoBackCommand.Execute(null);
            }
        }

        public delegate bool BackPressedEventHandler(object sender, Windows.Phone.UI.Input.BackPressedEventArgs e);
